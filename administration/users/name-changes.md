...
1. A member submits a name change request from their profile, providing their desired new username and a reason for the change.
2. The request appears in the Admin CP under **Name Changes** as a pending request.
3. An administrator reviews the request and either approves or denies it.
